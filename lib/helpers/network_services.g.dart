...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://dear-whole-moth.ngrok-free.app/api/';
  }
  ...
  @override
  Future<void> sendOtp(String param) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'email': param};
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<void> resetPassword(NewPasswordParams params) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ProfileResponseModel> getProfileData({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<List<DiseasePredictionResponse>> predictDisease(File image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<DiseasePredictionResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'multipart/form-data',
    ...
    var value = _result.data!
        .map((dynamic i) =>
            DiseasePredictionResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
